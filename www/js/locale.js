	...
	function loadar(){
	  ...
	  filerefjs.setAttribute("src", "js/rtl.jquery.mobile-1.4.0.js");
		...
		removejscssfile("jquery.mobile-1.4.2.js", "js") //remove all occurences of "somescript.js" on page
		removejscssfile("jquery.mobile-1.4.2.css", "css") //remove all occurences "somestyle.css" on page	
